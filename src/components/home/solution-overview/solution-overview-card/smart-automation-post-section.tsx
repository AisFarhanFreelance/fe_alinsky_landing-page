  ...
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-[1920px]">
        <div className="mx-8 grid min-h-[600px] grid-cols-1 place-content-center gap-9 rounded-[46px] bg-alinsky-midnight-blue p-8 alinsky-2xl:mx-[104px] alinsky-3xl:mx-[344px] sm:grid-cols-2 sm:p-12 xl:mx-[104px]">
          <div className="flex flex-col justify-center space-y-8 font-satoshi text-alinsky-white">
            <div className="flex flex-row items-center gap-x-4">
              ...
              <span className="text-base leading-[126%] font-medium tracking-[-0.48px] whitespace-nowrap sm:text-xl sm:tracking-[-0.6px]">
                Content Autopilot
              </span>
            </div>
