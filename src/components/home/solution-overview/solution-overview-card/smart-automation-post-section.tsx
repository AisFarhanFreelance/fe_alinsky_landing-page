...
const SmartAutomationPostSection = () => {
  return (
    <div className="mx-[104px] grid h-[600px] grid-cols-2 place-content-center gap-x-9 rounded-[46px] bg-alinsky-midnight-blue p-12 alinsky-3xl:mx-72">
      <div className="flex flex-col justify-center space-y-8 font-satoshi text-alinsky-white">
        ...
        <div className="space-y-3">
          ...
          <div className="text-left text-base leading-[140%] tracking-[0.1px] opacity-80">
            No more logging into five different platforms to schedule content.
            ALINSKY automates your entire posting calendar, letting you plan
            weeks ahead while ensuring every post goes out exactly when and
            where it should—with zero effort.
          </div>
        </div>
        <div>
