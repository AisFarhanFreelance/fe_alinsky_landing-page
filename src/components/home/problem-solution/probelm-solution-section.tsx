...
const ProblemSolutionSection = () => {
  return (
    <div className="mx-8 flex min-h-screen items-center justify-center rounded-t-4xl bg-alinsky-anti-flash-white">
      <div className="mt-14 mb-8 flex max-w-[874px] flex-col justify-center space-y-8">
        ...
        <div className="flex flex-col space-y-6 rounded-2xl bg-alinsky-midnight-blue px-16 py-6 font-satoshi text-alinsky-white capitalize">
          <span className="pt-16 text-9xl leading-[20%] font-bold">
            &ldquo;
          </span>
          <span className="text-[32px] leading-[150%] italic">
            If even one of these problems feels too real… It’s time to
            reflect&nbsp;:
            <b>
