...
function Card({ className, ...properties }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "inline-block gap-6 rounded-3xl border bg-alinsky-white-smoke text-card-foreground shadow-alinsky-soft",
        className,
      )}
      {...properties}
    />
...
function CardContent({
  ...
  return (
    <div data-slot="card-content" className={cn(className)} {...properties} />
  );
}
