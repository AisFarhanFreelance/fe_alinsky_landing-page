...
const ServiceBlockSection = () => {
  return (
    <div className="flex min-h-screen items-center justify-center">
      ...
      <div className="z-10 grid h-[600px] w-full grid-cols-3 items-center justify-center gap-8 p-8">
        ...
        <Card className="relative flex h-full flex-col justify-between overflow-hidden bg-alinsky-white">
          <CardContent className="mx-10 my-[64px] flex flex-1 flex-col justify-between">
            <div
              className="max-w-[306px] self-stretch font-helvetica text-[56px] leading-[60px] font-bold tracking-[-0.18px]"
              style={{
                backgroundImage:
